...
//reducer............
	...
	{
		private TreeMap<LongWritable, Text> Top5Employeer = new TreeMap<LongWritable, Text>();
		long sum=0;
		public void reduce(Text key,Iterable <LongWritable> values,Context context) throws IOException, InterruptedException
		{
			...
			Top5Employeer.put(new LongWritable(sum),new Text(key+","+sum));
			if (Top5Employeer.size()>5)
				Top5Employeer.remove(Top5Employeer.firstKey());
		}
		protected void cleanup(Context context)throws IOException, InterruptedException
		{
			for (Text t : Top5Employeer.descendingMap().values()) 
