...
//
// Debug information:
// Generated date: Sat Oct 14 12:18:28 IST 2017
...
public class question11 extends SqoopRecord  implements DBWritable, Writable {
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.success_rate = JdbcWritableBridge.readFloat(2, __dbResults);
    this.petitions = JdbcWritableBridge.readInteger(3, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeFloat(success_rate, 2 + __off, 7, __dbStmt);
    JdbcWritableBridge.writeInteger(petitions, 3 + __off, 4, __dbStmt);
    return 3;
  }
